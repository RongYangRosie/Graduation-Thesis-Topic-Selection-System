<?php
	...
	$SQL="create view possible_thesis2 as select * from thesis where thesis.major=(select major from student where sid='".$studentid."')";
	mysql_query($SQL);
	$sql1="select * from possible_thesis2 where thid='".$thid."'";
